        ...
        <div className="flex flex-col items-center xl:items-start">
          <div className="mb-2 p-3">
            <Link
              href="/"
              aria-label="X Home"
              className="flex h-full w-full items-center justify-center rounded-full p-2 transition-colors duration-200 hover:bg-neutral-800"
            >
              <X size={30} />
            </Link>
          </div>
          ...
          <nav className="flex flex-col items-center xl:items-start">
            {sidebarLinks.map((link) => {
              ...
              return (
                <SidebarLink key={link.title} {...link} isActive={isActive} />
              );
            })}
          </nav>
              ...
              <Popover.Portal>
                ...
                >
                  <div className="flex flex-col text-sm">
                    <a
                      href="#"
                      className="p-4 font-bold transition-colors hover:bg-neutral-900"
                    >
