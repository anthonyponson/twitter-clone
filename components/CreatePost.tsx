      ...
      <div className="flex-1">
        ...
        <div className="mt-4 flex items-center justify-between">
          <div className="flex gap-1">
            ...
            <button className="rounded-full p-2 text-sky-500 transition-colors duration-200 hover:bg-sky-500/10">
              <List size={20} />
            </button>
            <button className="rounded-full p-2 text-sky-500 transition-colors duration-200 hover:bg-sky-500/10">
              <Smile size={20} />
            ...
            className={clsx(
              "rounded-full px-4 py-1.5 font-bold text-white transition-all duration-200",
              {
                "bg-sky-500 hover:bg-sky-600":
                  (content.trim() || imageUrl) && !isSubmitting,
                "cursor-not-allowed bg-sky-900 text-neutral-500":
                  (!content.trim() && !imageUrl) || isSubmitting,
              },
            )}
          >
